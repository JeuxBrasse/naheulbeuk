...
export class NaheulbeukActorSheet extends foundry.appv1.sheets.ActorSheet {
  ...
  _prepareItems(context) { //permet l'accès dans les doc html
    ...
    context.apes = apes;
    context.categoriemagique=["generaliste","combat","feu","metamorphose","thermodynamique","invocation","necromancie","eau","terre","air","tzinntch","pr-niourgl","pr-dlul","pr-youclidh","pr-slanoush","pr-adathie","pa-niourgl","pa-slanoush","pa-dlul","pa-braav","pa-khornettoh","pa-crom","chamane"]
  }
