  ...
  constructor({roll={}, ability="", ...fields}={}, options={}) {
    ...
    fields = {
      ability: (ability === false) ? null : new StringField({
        required: true,
        initial: ability,
        label: "NAHEULBEUK.AbilityModifier"
      }),
      roll: new SchemaField({
        min: new NumberField({...opts, label: "NAHEULBEUK.ROLL.Range.Minimum"}),
        max: new NumberField({...opts, label: "NAHEULBEUK.ROLL.Range.Maximum"}),
