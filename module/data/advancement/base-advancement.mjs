  ...
  static defineSchema() {
    return {
      ...
      level: new NumberField({
        integer: true, initial: this.metadata?.multiLevel ? undefined : 0, min: 0, label: "NAHEULBEUK.Level"
      }),
      title: new StringField({initial: undefined, label: "NAHEULBEUK.AdvancementCustomTitle"}),
      hint: new StringField({label: "NAHEULBEUK.AdvancementHint"}),
      icon: new FilePathField({
        initial: undefined, categories: ["IMAGE"], label: "NAHEULBEUK.AdvancementCustomIcon", base64: true
      }),
      classRestriction: new StringField({
        initial: undefined, choices: ["primary", "secondary"], label: "NAHEULBEUK.AdvancementClassRestriction"
      })
    };
  }
