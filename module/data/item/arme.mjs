export default class ArmeData extends foundry.abstract.TypeDataModel {
    static defineSchema() {
        ...
        let data = {
            ...
            name6: new StringField({initial: ""}),
            name7: new StringField({initial: ""}),
            ...
            epreuve6: new StringField({initial: ""}),
            epreuve7: new StringField({initial: ""}),
            ...
            jet6: new StringField({initial: ""}),
            jet7: new StringField({initial: ""}),
            epreuvecustom: new BooleanField({initial: false}),
            prbouclier: new BooleanField({initial: false}),
            ...
            categorie: new StringField({initial: "Armes"}),
            armefeu: new BooleanField({initial: false}),
            munition: new BooleanField({initial: false}),
            arme_distance: new BooleanField({initial: false}),
            arme_cac: new BooleanField({initial: false}),
            arme_autre: new BooleanField({initial: false}),
            ...
            stockage: new StringField({initial: "tous sauf indications contraires"}),
            deuxmains: new BooleanField({initial: false}),
