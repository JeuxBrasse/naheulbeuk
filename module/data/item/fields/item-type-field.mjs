  ...
  constructor(options={}, schemaOptions={}) {
    const fields = {
      value: new StringField({
        required: true, blank: true, initial: options.value ?? "", label: "NAHEULBEUK.Type"
      }),
      subtype: new StringField({
        required: true, blank: true, initial: options.subtype ?? "", label: "NAHEULBEUK.Subtype"
      }),
      baseItem: new StringField({
        required: true, blank: true, initial: options.baseItem ?? "", label: "NAHEULBEUK.BaseItem"
      })
    };
