...
export class ActorDeltasField extends SchemaField {
   ...
   * @param {ActorNaheulbeuk} actor                    Actor for which to calculate the deltas.
   ...
   * @param {ActorNaheulbeuk} actor   Actor to which this delta applies.
...
export class IndividualDeltaField extends SchemaField {
   ...
   * @param {ActorNaheulbeuk|ItemNaheulbeuk} doc  Actor or item to which this delta applies.
   * @param {Roll[]} [rolls]      Rolls that may be associated with a delta.
   * @returns {DeltaDisplayContext}
   */
