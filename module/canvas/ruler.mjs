export default class TokenRulerNaheulbeuk extends foundry.canvas.placeables.tokens.TokenRuler {
  /** @inheritDoc */
  ...
  #getSpeedBasedStyle(waypoint, style) {
    ...
    if ( CONFIG.NAHEULBEUK.movementTypes[waypoint.action]?.walkFallback
      || !CONFIG.NAHEULBEUK.movementTypes[waypoint.action] ) {
    ...
    const { normal, double, triple } = CONFIG.NAHEULBEUK.tokenRulerColors;
