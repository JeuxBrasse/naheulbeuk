...
export default function PseudoDocumentMixin(Base) {
  class PseudoDocument extends Base {
    ...
    static get documentConfig() {
      return CONFIG.NAHEULBEUK[`${this.documentName.toLowerCase()}Types`];
    }
     ...
     * @param {ItemNaheulbeuk} context.parent        A parent for the Activity.
     ...
     * @param {ItemNaheulbeuk} parent  Parent document within which this PseudoDocument will be created.
