...
export default class CastActivity extends ActivityMixin(BaseCastActivityData) {
   ...
   */
  static ENCHANTMENT_ID = staticID("naheulbeukspellchanges");

  /* -------------------------------------------- */

  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "NAHEULBEUK.CAST"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "cast",
      img: "systems/naheulbeuk/icons/svg/activity/cast.svg",
      title: "NAHEULBEUK.CAST.Title",
      hint: "NAHEULBEUK.CAST.Hint",
  ...
  get cachedSpell() {
    return this.actor?.sourcedItems.get(this.spell.uuid)
      ?.find(i => i.getFlag("naheulbeuk", "cachedFor") === this.relativeUUID);
  }
  ...
  async use(usage={}, dialog={}, message={}) {
     ...
     * @function naheulbeuk.preUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("naheulbeuk.preUseLinkedSpell", this, usage, dialog, message) === false ) return;
     ...
     * @function naheulbeuk.postUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( results ) Hooks.callAll("naheulbeuk.postUseLinkedSpell", this, usage, results);
    ...
    return originalSpell.clone({
      effects: [
        ...originalSpell.effects.map(e => e.toObject()),
        {
          ...
          type: "enchantment",
          name: game.i18n.localize("NAHEULBEUK.CAST.Enchantment.Name"),
          img: "systems/naheulbeuk/icons/svg/activity/cast.svg",
          origin: this.uuid,
