...
export default class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/naheulbeuk/templates/advancement/advancement-confirmation-dialog.hbs",
      jQuery: false
    });
  }
   ...
   * @param {ItemNaheulbeuk} item  Item to be deleted.
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("NAHEULBEUK.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("NAHEULBEUK.AdvancementDeleteConfirmationMessage"),
      {
   ...
   * @param {ItemNaheulbeuk} item  The class whose level is being changed.
   * @returns {Promise<boolean|null>}  Resolves with whether advancements should be unapplied. Rejects with null.
   */
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("NAHEULBEUK.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("NAHEULBEUK.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("NAHEULBEUK.LevelActionDecrease")
      }
    );
  }
   ...
   * @param {ItemNaheulbeuk} item              Item to be changed.
