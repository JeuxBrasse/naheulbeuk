 ...
 *
 * @param {ItemNaheulbeuk} item           Item to which the advancement belongs.
...
export default class AdvancementFlow extends FormApplication {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/naheulbeuk/templates/advancement/advancement-flow.hbs",
      popOut: false
    });
  }
  ...
  /** @inheritDoc */
  static _customElements = super._customElements.concat(["naheulbeuk-checkbox"]);
