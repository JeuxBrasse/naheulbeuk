 ...
 */
export default class PseudoDocumentSheet extends ApplicationNaheulbeuk {
  constructor(options={}) {
    super(options);
  ...
  _prepareSubmitData(event, formData) {
    ...
    this.element.querySelectorAll("fieldset legend :is(input, select, naheulbeuk-checkbox)").forEach(input => {
