import ApplicationNaheulbeuk from "./application.mjs";

/**
 * Application for creating Naheulbeuk dialogs.
 */
export default class DialogNaheulbeuk extends ApplicationNaheulbeuk {
  /** @override */
  ...
  static PARTS = {
    content: {
      template: "systems/naheulbeuk/templates/shared/dialog-content.hbs"
    },
    footer: {
