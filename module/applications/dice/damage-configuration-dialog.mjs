...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    formulas: {
      template: "systems/naheulbeuk/templates/dice/damage-formulas.hbs"
    }
  };
  ...
  async _prepareButtonsContext(context, options) {
    ...
    context.buttons = {
      critical: {
        ...
        label: game.i18n.localize("NAHEULBEUK.CriticalHit")
      },
      normal: {
        default: !defaultCritical,
        icon: '<i class="fa-solid fa-dice" inert></i>',
        label: game.i18n.localize(allowCritical ? "NAHEULBEUK.Normal" : "NAHEULBEUK.Roll")
      }
    };
  ...
  async _prepareFormulasContext(context, options) {
    ...
    const allTypes = foundry.utils.mergeObject(CONFIG.NAHEULBEUK.damageTypes, CONFIG.NAHEULBEUK.healingTypes, { inplace: false });
