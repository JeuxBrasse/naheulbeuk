 ...
 */
export default class SetDateDialog extends DialogNaheulbeuk {
  /** @override */
  static DEFAULT_OPTIONS = {
    ...
    window: {
      title: "NAHEULBEUK.CALENDAR.Action.SetDate"
    }
  };
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/naheulbeuk/templates/apps/set-date-dialog.hbs"
    }
  };
    ...
    context.fields = [
      {
        ...
        label: game.i18n.localize("NAHEULBEUK.CALENDAR.Component.Year"),
        name: "year",
      ...
      },
      {
        ...
        label: game.i18n.localize("NAHEULBEUK.CALENDAR.Component.Month"),
        name: "month",
      ...
      },
      {
        ...
        label: game.i18n.localize("NAHEULBEUK.CALENDAR.Component.Day"),
        name: "day",
        value: dayOfMonth + 1
      }
    ];
