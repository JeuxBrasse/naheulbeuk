 ...
 */
export default class BaseCalendarHUD extends ApplicationNaheulbeuk {
  /** @inheritDoc */
  ...
  static get shouldDisplay() {
    return (game.settings.get("naheulbeuk", "calendarConfig")?.enabled || false)
      && (game.settings.get("naheulbeuk", "calendarPreferences")?.visible || false);
  }
  ...
  static onUpdateWorldTime(worldTime, deltaTime, options, userId) {
    if ( this.shouldDisplay ) naheulbeuk.ui.calendar?.render();
  }
}
