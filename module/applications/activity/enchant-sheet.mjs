...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/naheulbeuk/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/naheulbeuk/templates/activity/parts/enchant-enchantments.hbs",
        "systems/naheulbeuk/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
  ...
  async _prepareEffectContext(context, options) {
    ...
    context.typeOptions = [
      { value: "", label: game.i18n.localize("NAHEULBEUK.ENCHANT.FIELDS.restrictions.type.Any"), rule: true },
    ...
    context.propertyOptions = (CONFIG.NAHEULBEUK.validProperties[type] ?? [])
      .map(value => ({ value, label: CONFIG.NAHEULBEUK.itemProperties[value]?.label ?? value }));
  ...
  _getTabs() {
    ...
    tabs.effect.label = "NAHEULBEUK.ENCHANT.SECTIONS.Enchanting";
    ...
    tabs.effect.tabs = this._markTabs({
      enchantments: {
        ...
        label: "NAHEULBEUK.ENCHANT.SECTIONS.Enchantments"
      },
      restrictions: {
        id: "restrictions", group: "effect", icon: "fa-solid fa-ban",
        label: "NAHEULBEUK.ENCHANT.SECTIONS.Restrictions"
      }
    });
    return tabs;
  }
