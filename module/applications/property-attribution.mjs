 ...
 */
export default class PropertyAttribution extends ApplicationNaheulbeuk {
  ...
  static PARTS = {
    attribution: {
      template: "systems/naheulbeuk/templates/apps/property-attribution.hbs"
    }
  };
  ...
  getPropertyLabel(property) {
    ...
    if ( parts[0] === "abilities" && parts[1] ) {
      return CONFIG.NAHEULBEUK.abilities[parts[1]]?.label ?? property;
    } else if ( (property === "attributes.ac.dex") && CONFIG.NAHEULBEUK.abilities.dex ) {
      return CONFIG.NAHEULBEUK.abilities.dex.label;
    } else if ( (parts[0] === "prof") || (property === "attributes.prof") ) {
      return game.i18n.localize("NAHEULBEUK.Proficiency");
    }
    return property;
  }
}
